...
const fetchKBCoinsContract = (signerOrProvider) =>
  new ethers.Contract(kbcoinsAddress, kbcoinsABI, signerOrProvider);

const fetchKBCoinsSaleContract = (signerOrProvider) =>
  new ethers.Contract(kbcoinsSaleAddress, kbcoinsSaleABI, signerOrProvider);
...
export const ERC20ICONProvider = ({ children }) => {
  ...
  const kbcoins = "ICO Name: KBCoins";
  ...
  const checkIfWalletConnected = async () => {
    ...
    const contract = fetchKBCoinsContract(signer);
