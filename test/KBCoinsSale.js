var KBCoins = artifacts.require("../contracts/KBCoins.sol");
var KBCoinsSale = artifacts.require("../contracts/KBCoinsSale.sol");

contract("KBCoinsSale", function (accounts) {
  var tokenInstance;
  ...
  it("ends token sale", function () {
    return KBCoins.deployed()
      ...
      .then(function (balance) {
        ...
        // assert.equal(balance.toNumber(), 0, "Hey contract 0 balance");
      });
  });
});
